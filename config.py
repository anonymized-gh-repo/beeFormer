...
config = {
    ...
    (
        Dataset("Goodbooks-10k"),
        {
            ...
            "random_state": 42,
            "load_previous_splits": False,
            "items_raw_data": """pd.read_feather("datasets/goodbooks/item_text_descriptions.feather")""",
    ...
    (
        ...
        {
            "raw_data" : """pd.read_feather("datasets/amazbooks/ratings.feather")""",
            "value_name" : "rating",
            "item_id_name": "asin",
            "user_id_name": "uid",
            "timestamp_name" : "timestamp",
            ...
            "max_steps": 1000,
            "load_previous_splits": False,
            "items_raw_data": """pd.read_feather("datasets/amazbooks/item_text_descriptions.feather")""",
